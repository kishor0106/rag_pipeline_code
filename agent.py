...
financial_tool = VertexAiRagRetrieval(
    ...
    rag_resources=[
        rag.RagResource(rag_corpus=f"projects/{PROJECT_ID}/locations/{LOCATION}/ragCorpora/FINANCIAL_CORPUS_ID")
    ],
    similarity_top_k=5,
...
insurance_tool = VertexAiRagRetrieval(
    ...
    rag_resources=[
        rag.RagResource(rag_corpus=f"projects/{PROJECT_ID}/locations/{LOCATION}/ragCorpora/INSURANCE_CORPUS_ID")
    ],
    similarity_top_k=5,
    vector_distance_threshold=0.75
)
...
general_tool = VertexAiRagRetrieval(
    ...
    rag_resources=[
        rag.RagResource(rag_corpus=f"projects/{PROJECT_ID}/locations/{LOCATION}/ragCorpora/GENERAL_CORPUS_ID")
    ],
    similarity_top_k=5,
    vector_distance_threshold=0.75
)
